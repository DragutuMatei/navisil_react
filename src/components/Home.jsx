    ...
    <>
      ...
      <div className="container-fluid pt-5 pb-3">
        ...
        <div className="row px-xl-5 products">
          <Product link={"/prod/1"} name="Numele produsului1" price={123.2} oldPrice={321.3} review={4} />
          <Product link={"/prod/2"} name="Numele produsului2" price={123.2} oldPrice={321.3} review={4} />
          <Product link={"/prod/3"} name="Numele produsului3" price={123.2} oldPrice={321.3} review={4} />
          <Product link={"/prod/4"} name="Numele produsului4" price={123.2} oldPrice={321.3} review={4} />
          <Product link={"/prod/5"} name="Numele produsului5" price={123.2} oldPrice={321.3} review={4} />
          <Product link={"/prod/6"} name="Numele produsului6" price={123.2} oldPrice={321.3} review={4} />
          <Product link={"/prod/7"} name="Numele produsului7" price={123.2} oldPrice={321.3} review={4} />
          <Product link={"/prod/8"} name="Numele produsului8" price={123.2} oldPrice={321.3} review={4} />
